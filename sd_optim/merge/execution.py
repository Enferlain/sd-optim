    ...
    *,
    ...
    try:
        ...
        utils.merge_with_model_dirs(
            ...
            output=model_path,
            fallback_model=None,
            merge_device=merger.cfg.get("device", "cpu"),
            merge_dtype=PRECISION_MAPPING.get(merger.cfg.merge_dtype),
            output_device="cpu",
            output_dtype=PRECISION_MAPPING.get(merger.cfg.save_dtype),
            threads=merger.cfg.get("threads"),
